...
@section('content')
    <div class="space-y-6">
        <h1 class="text-3xl font-bold text-gray-900">Semua Pengajuan</h1>

        <!-- Filter Section -->
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <form method="GET" action="{{ route('admin.pengajuan.semua') }}" class="space-y-4">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-sm">
                                    <div class="flex items-center gap-2">
                                        @if($item['jenis'] === 'Perolehan Kredit')
                                            <a
                                                href="{{ route('admin.pengajuan.semua.show', ['jenis' => 'perolehan-kredit', 'id' => $item['id']]) }}"
                                        ...
                                        @else
                                            <a
                                                href="{{ route('admin.pengajuan.semua.show', ['jenis' => 'transfer-kredit', 'id' => $item['id']]) }}"
                                                class="text-blue-600 hover:text-blue-900 hover:underline"
                                            >
                                                Lihat Detail
                                            </a>
                                        ...
                                        <a
                                            href="{{ route('admin.pengajuan.semua.identitas', $item['mahasiswa_id']) }}"
